...
$(document).ready(function () {
	...
	{
	    $('#bs-css').attr('href', '/adminpanel/css/bootstrap-' + theme_name + '.css');
	    $('#kendo-css').attr('href', '/Content/web/kendo.' + myMappings[theme_name] + '.min.css');
	}
...
function docReady(){
    ...
    var elf = $('.file-manager').elfinder({
	    ...
	    commands: [
            'open', 'reload', 'home', 'getfile', 'quicklook',
            'download', 'rm', 'duplicate', 'mkdir', 'upload', 'copy',
            'cut', 'paste', 'editimage', 'info', 'view', 'sort'
	    ],
	    uiOptions: {
