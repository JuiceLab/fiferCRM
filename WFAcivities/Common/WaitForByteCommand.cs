...
namespace WFActivities.Common
{
    ...
    /// </summary>
    public sealed class WaitForByteCommand : NativeActivity<object>
    {
        //Expected status for rewumeworkflow
        public InArgument<byte> Command { get; set; }
        //TicketId(obsolete) 
