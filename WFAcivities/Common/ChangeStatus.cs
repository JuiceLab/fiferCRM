...
namespace WFActivities.Common
{
    ...
    /// </summary>
    public sealed class ChangeStatus : CodeActivity
    {
        //Obj for change status
        public InArgument<IStatus> QueryItem { get; set; }
        //Predefined enum status
        public InArgument<WFStatus> Status { get; set; }
        //Any other status
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            WFStatus status = Status.Get(context);
            ...
            {
                regParticipant.IdWF = queryItem.ChangeStatus((int)status, customStatus).ToString();
            }
        }
    }
}
